...
allLng = {
    'zh_cn': {
        ...
        'sign_in': '请登录',
        'login_expired': '登录失效',
        'openlist_not_found': '未找到 OpenList 引擎，可能已经被删除',
        'del_job_course_error': '作业启动过程中报错，将自动删除作业，任务信息：{}',
        'job_not_found': '未找到作业，可能已经被删除',
        'task_not_found': '未找到任务，可能已经被删除',
        'user_not_found': '用户不存在',
        'openlist_connect_fail': 'OpenList 连接失败，请检查是否填写正确',
        'address_incorrect': 'OpenList 地址格式有误',
        'code_not_200': '状态码非 200',
        'openlist_un_auth': 'OpenList 鉴权失败，可能是令牌已失效',
        'openlist_fail_code_reason': 'OpenList 返回 {} 错误，原因为：{}',
        'without_token': '地址变化时令牌必填',
        'add_openlist_client_fail': '新增 OpenList 客户端时失败，原因为：{}',
        'task_may_delete': '任务未找到。可能是您手动到 OpenList 中删除了复制任务；或者 OpenList 因手动/异常崩溃被重启，导致任务记录丢失',
        ...
        'cron_lost': '创建 cron 型任务时，至少有一项不为空',
        ...
        'keep_all_log': '日志保留时间为 0，将保留所有日志',
        'keep_all_task': '任务保留时间为 0，将保留所有任务',
        'clear_task_start': '定时清理任务启动成功',
        'passwd_wrong': '密码错误',
        'key_wrong': '加密密钥错误',
        'passwd_wrong_max_time': '5 分钟内密码错误超过 3 次，请稍后再试',
        'task_status': ['等待中', '进行中', '成功', '完成（部分失败）', '因重启而中止', '超时', '失败', '手动中止', '无需同步'],
        'task_end_msg_title': '{} - TaoSync',
        'task_end_msg_content': '来源目录为 {}、目标目录为 {} 的作业执行结束。\n\n共有 {} 个需要同步的文件，成功 {} 个，失败 {} 个。',
        'task_end_msg_content_ext': '\n\n本次同步共耗时：{}，成功同步 {} 文件。',
        'hms': '{} 小时 {} 分 {} 秒',
        'task_end_msg_error': '失败原因为：{}',
        'notify_error': '发送通知过程中失败，原因为：{}',
        'notify_test_msg': '这是一条由您自己发送的 TaoSync 测试消息，当你看到这条消息，说明你的配置是正确可用的。'
    },
    'eng': {
        'success': 'success',
        'lost_part': 'Incomplete parameters',
        'same_exists': 'The same data already exists, please check!',
        'sign_in': 'Please sign in',
        'login_expired': 'Login expired',
        'openlist_not_found': 'OpenList engine not found, may have been deleted',
        ...
        'openlist_connect_fail': 'OpenList connection failed, please check whether it is filled in correctly',
        'address_incorrect': 'The OpenList address format is incorrect',
        'code_not_200': 'Code not 200',
        'openlist_un_auth': 'OpenList authentication failed, possibly because the token has expired',
        'openlist_fail_code_reason': 'OpenList returns {}, reason: {}',
        'without_token': 'Token is required when address changes',
        'add_openlist_client_fail': 'Failed to add OpenList client, reason: {}',
        'task_may_delete': 'Task not found. You may have manually deleted the copy task in OpenList, or OpenList was restarted manually or abnormally, causing task records to be lost',
        'do_job_err': 'Task execution failed due to: {}',
        'src': 'source',
        'dst': 'target',
        'scan_error': '{} directory scan failed due to: {}',
        'copy_success_but_delete_fail': 'The file was copied successfully, but deleting the source file failed due to: {}',
        ...
        'cron_lost': 'When creating a cron job, at least one item must be non-empty',
        ...
        'task_status': ['waiting', 'in progress', 'success', 'complete (partially failed)', 'aborted due to reboot', 'timeout', 'failed', 'aborted by manual', 'no files need sync'],
        'task_end_msg_title': '{} - TaoSync',
